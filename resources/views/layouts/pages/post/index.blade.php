                            ...
                            <div class="columns">
                                <div class="column is-9">
                                    <article class="p-l-20">
                                        ...
                                        <h4 class="title is-3 m-t-20 has-text-weight-medium is-capitalized">@{{ item.title }}</h4>
                                        <h6 class="subtitle is-5 m-t-50 has-text-grey has-text-weight-medium">@{{ item.excerpt }}</h6>
                                        <h6 class="is-white m-t-100 subtitle is-size-6 has-text-weight-bold is-uppercase">learn more</h6>
                                    </article>
                                </div>
